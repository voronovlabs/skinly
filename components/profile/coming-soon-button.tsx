  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div
            className="w-full max-w-[480px] rounded-xl bg-warm-white shadow-soft-xl p-6 flex flex-col gap-4"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between">
              <span className="text-h3 text-graphite">{t("comingSoonTitle")}</span>
              <button
                type="button"
                onClick={() => setOpen(false)}
