/**
 * HTTP fetcher для inn-skin.ru: rate-limit + retries + exponential backoff.
 * Native Node fetch, без axios/got. Структурно идентичен national-catalog,
 * но со своим config'ом (вежливее интервал, свои headers).
 */
...
/**
 * Скачивает HTML. На 429/5xx/timeout — до MAX_RETRIES повторов с
 * экспоненциальной задержкой. На 4xx (кроме 429) — фатал, не ретраим.
 */
